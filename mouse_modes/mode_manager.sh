...
handle_volume_up() {
    if was_volume_pressed_recently; then
        ...
        /home/twain/Projects/mouse_modes/volume_up_10.sh
    else
...
handle_volume_down() {
    ...
    /home/twain/Projects/mouse_modes/volume_down_10.sh
}
...
execute_script() {
    ...
    local script_path="/home/twain/Projects/mouse_modes/mouse_modes/$mode_name/$button_name.sh"
    ...
    if [ -x "$script_path" ]; then
        ...
        local default_script="/home/twain/Projects/mouse_modes/mouse_modes/default/$button_name.sh"
